...
@interface TumblViewController () <TMNetworkActivityIndicatorManager, TMSessionTaskUpdateDelegate>
...
@end
@implementation TumblViewController
...
- (void)authenticate {
  [self.authenticator authenticate:@"ello" callback:^(TMAPIUserCredentials * creds, NSError * networkingError) {
